...
**Goal.** In this post, I will prove the properties of the Pfaffian using **only** the wedge product calculation.

**Reason.** There are many ways to prove the properties of the Pfaffian:
...
- $A\oplus B$ denotes the block-diagonal direct sum.
- $\det(\cdot)$ denotes the determinant and $\operatorname{pf}(\cdot)$ denotes the Pfaffian.
...
$$
f_1 \wedge f_2 \wedge \cdots \wedge f_{n} = \det(M)\; e_1 \wedge e_2 \wedge \cdots \wedge e_{n}
$$
...
$$
\operatorname{pf}(BAB^{\text{T}}) = \operatorname{pf}(A)\det(B)
$$
...
&= \operatorname{pf}(A)\det(B) \; e_1 \wedge e_2 \wedge \cdots \wedge e_{2n}.
\end{aligned}
$$
...
$$
\boxed{\operatorname{pf}(BAB^{\text{T}}) = \operatorname{pf}(A)\det(B).}
$$
...
$$
\operatorname{pf}(A^{\text{T}}) = \operatorname{pf}(-A) = (-1)^{n} \operatorname{pf}(A)
$$
...
**Statement.** Let $A\in \mathbb{R}^{2n \times 2n}$ and $B\in \mathbb{R}^{2m \times 2m}$, then

$$
\operatorname{pf}(A\oplus B) = \operatorname{pf}(A)\operatorname{pf}(B)
$$
...
**Statement.** For an arbitrary $n \times n$ matrix $M$, let
...
$$
\operatorname{pf}(K)=(-1)^{n(n-1)/2} \det(M)
$$
